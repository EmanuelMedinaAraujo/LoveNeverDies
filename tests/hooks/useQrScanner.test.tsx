 ...
 * dass er ohne `BarcodeDetector` gar nicht erst nach der Kamera fragt, dass
...
describe('useQrScanner', () => {
  it('fragt gar nicht erst nach der Kamera, wenn der Browser kein BarcodeDetector hat', () => {
