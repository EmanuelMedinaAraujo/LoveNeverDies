...
describe('Fallsperre (§7)', () => {
  ...
  it('sagt bei einem gesperrten Fall, dass er gesperrt ist', () => {
    ...
    // §3.6: Der Weg zur Freigabe gehört an diese Stelle und nicht drei Klicks
    // entfernt.
    expect(screen.getByRole('link', { name: 'Dieses Gerät freischalten lassen' })).toHaveAttribute(
      'href',
      '/geraet-freischalten',
    )
  })
